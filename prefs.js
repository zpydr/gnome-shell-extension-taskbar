...
Prefs.prototype =
{
    ...
    buildPrefsWidget: function()
    {
        ...
        this.valueCloseButton.append_text("OFF");
        this.valueCloseButton.append_text("Middle Click");
        this.valueCloseButton.append_text("Right Click");
        ...
        this.valueDesktopButtonIcon.append_text("Default");
        this.valueDesktopButtonIcon.append_text("GNOME");
        this.valueDesktopButtonIcon.append_text("Dark");
        ...
        this.grid.attach(this.valueDesktopButtonIcon, 3, 10, 3, 1);
        ...
        this.grid.attach(this.valueDesktopButtonRightClick, 4, 11, 2, 1);
        ...
        this.valueWorkspaceButtonIndex.append_text("Index");
        this.valueWorkspaceButtonIndex.append_text("Index/Total");
        ...
        this.valueShowAppsButtonToggle.append_text("L Appview\nR Overview");
        this.valueShowAppsButtonToggle.append_text("L Overview\nR Appview");
        ...
        this.grid.attach(this.valueShowAppsButtonToggle, 3, 13, 3, 1);
        ...
        this.grid.attach(this.valueHideActivities, 4, 14, 2, 1);
        ...
        this.grid.attach(this.valueDisableHotCorner, 4, 15, 2, 1);
        ...
        this.grid.attach(this.valueHideDefaultApplicationMenu, 4, 16, 2, 1);
        ...
        this.grid.attach(this.valueDisplayFavoritesLabel, 4, 21, 2, 1);
