...
Prefs.prototype =
{
    ...
    buildPrefsWidget: function()
    {
        ...
        let labelAdjustments = new Gtk.Label({ label: "\n<b>"+_("Adjustments")+"</b>", use_markup: true, xalign: 0});
        ...
        this.grid.attach(this.valueCloseButton, 3, 9, 3, 1);

        let labelActiveTaskFrame = new Gtk.Label({label: _("Active Task Frame"), xalign: 0});
        this.grid.attach(labelActiveTaskFrame, 1, 10, 1, 1);
        ...
        let labelHoverSwitchTask = new Gtk.Label({label: _("Switch Task on Hover"), xalign: 0});
        ...
        this.grid.attach(this.valueHoverSwitchTask, 4, 11, 2, 1);

        let labelDesktopButtonIcon = new Gtk.Label({label: _("Desktop Button Icon"), xalign: 0});
        this.grid.attach(labelDesktopButtonIcon, 1, 12, 1, 1);
        ...
        this.grid.attach(this.valueDesktopButtonRightClick, 4, 13, 2, 1);

        let labelWorkspaceButtonIndex = new Gtk.Label({label: _("Workspace Button Index"), xalign: 0});
        this.grid.attach(labelWorkspaceButtonIndex, 1, 14, 1, 1);
        ...
        this.grid.attach(this.valueWorkspaceButtonIndex, 3, 14, 3, 1);

        let labelShowAppsButtonToggle = new Gtk.Label({label: _("Appview Button\nL/R Click Toggle"), xalign: 0});
        this.grid.attach(labelShowAppsButtonToggle, 1, 15, 1, 1);
        ...
        this.grid.attach(this.valueShowAppsButtonToggle, 3, 15, 3, 1);

        let labelHideActivities = new Gtk.Label({label: _("Hide Activities")+" *", xalign: 0});
        this.grid.attach(labelHideActivities, 1, 16, 1, 1);
        ...
        this.grid.attach(this.valueHideActivities, 4, 16, 2, 1);

        let labelDisableHotCorner = new Gtk.Label({label: _("Disable Hot Corner")+" *", xalign: 0});
        this.grid.attach(labelDisableHotCorner, 1, 17, 1, 1);
        ...
        this.grid.attach(this.valueDisableHotCorner, 4, 17, 2, 1);

        let labelHideDefaultApplicationMenu = new Gtk.Label({label: _("Hide Default App Menu")+" *", xalign: 0});
        this.grid.attach(labelHideDefaultApplicationMenu, 1, 18, 1, 1);
        ...
        this.grid.attach(this.valueDisplayLabel, 4, 21, 2, 1);

        let labelDisplayThumbnail = new Gtk.Label({label: _("Tasks Thumbnail"), xalign: 0});
        this.grid.attach(labelDisplayThumbnail, 1, 22, 1, 1);
        ...
        this.grid.attach(this.valueDisplayThumbnail, 4, 22, 2, 1);

        let labelDisplayFavoritesLabel = new Gtk.Label({label: _("Favorites Label"), xalign: 0});
        this.grid.attach(labelDisplayFavoritesLabel, 1, 23, 1, 1);
        ...
        this.grid.attach(this.valueDisplayFavoritesLabel, 4, 23, 2, 1);

        let labelPreviewSize = new Gtk.Label({label: _("Thumbnail Size")+" [350]", xalign: 0});
        this.grid.attach(labelPreviewSize, 1, 24, 1, 1);
        ...
        this.grid.attach(value2PreviewSize, 3, 24, 3, 1);

        let labelPreviewDelay = new Gtk.Label({label: _("Preview Delay")+" [500] "+_("(ms)"), xalign: 0});
        this.grid.attach(labelPreviewDelay, 1, 25, 2, 1);
        ...
        this.grid.attach(this.valueAppearanceOne, 1, 28, 1, 1);
        ...
        this.grid.attach(this.valueAppearanceTwo, 1, 29, 1, 1);
        ...
        this.grid.attach(this.valueAppearanceThree, 1, 30, 1, 1);
        ...
        this.grid.attach(this.valueAppearanceFour, 1, 31, 1, 1);
        ...
        this.grid.attach(this.valueAppearanceFive, 1, 32, 1, 1);
        ...
        this.grid.attach(resetButton, 3, 34, 3, 1);
        this.grid.attach(labelLink1, 1, 34, 1, 1);
        ...
        this.grid.attach(labelLink2, 1, 35, 1, 1);
        let labelVersion = new Gtk.Label({label: _("Version")+" 23"});
        this.grid.attach(labelVersion, 3, 35, 3, 1);
        ...
        this.grid.attach(labelSpace5, 0, 33, 1, 1);
        let labelSpace6 = new Gtk.Label({label: "\t", xalign: 0});
        this.grid.attach(labelSpace6, 0, 36, 1, 1);
    },
